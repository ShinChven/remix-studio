...
flowchart LR
    ...
    O --> D["Albums · Exports · Campaigns · Stores"]
```
...
- **Turn output into operations** — Keep results in durable albums, reuse prior configurations, edit and export assets, add watermarks, deliver archives to Google Drive, publish products to Gumroad, or schedule campaigns for X and Threads.

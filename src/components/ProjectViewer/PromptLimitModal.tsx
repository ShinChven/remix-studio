...
export function PromptLimitModal({
  ...
  return (
    <div className="fixed inset-0 z-[320] flex items-center justify-center p-4 md:p-8">
      ...
      <div className="relative w-full max-w-xl overflow-hidden rounded-[28px] border border-neutral-800 bg-neutral-900 shadow-2xl">
        <div className="border-b border-neutral-800 bg-neutral-950/40 p-6">
        ...
        <div className="flex flex-col gap-3 border-t border-neutral-800/50 bg-neutral-950/30 p-5 sm:flex-row sm:justify-end">
          <button
            onClick={onCancel}
            className="rounded-xl border border-neutral-800 px-5 py-3 text-[10px] font-black uppercase tracking-[0.2em] text-neutral-400 transition-all hover:bg-neutral-800/60 hover:text-white"
          >
            {t('projectViewer.promptLimitModal.cancel')}
          </button>
          <button
            onClick={onKeep}
            className="rounded-xl border border-neutral-700 bg-neutral-800/60 px-5 py-3 text-[10px] font-black uppercase tracking-[0.2em] text-white transition-all hover:bg-neutral-700"
          >

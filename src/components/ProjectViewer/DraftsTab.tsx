            ...
            selectionActions={
              <>
                ...
                <button
                  ...
                  title={t('projectViewer.drafts.startSelected')}
                  aria-label={t('projectViewer.drafts.startSelected')}
                ...
                >
                  ...
                  <span className="hidden sm:inline">{t('projectViewer.drafts.startSelected')}</span>
                </button>
              </>
            }
            rightActions={
              <>
                <button
                  ...
                  className="flex items-center justify-center gap-1.5 min-h-8 min-w-8 px-2 sm:px-3 py-1.5 text-neutral-500 hover:text-red-400 text-[9px] font-black uppercase tracking-widest rounded-lg transition-all"
                  title={t('projectViewer.drafts.deleteAllDrafts')}
                  aria-label={t('projectViewer.drafts.deleteAllDrafts')}
                >
                  <Trash2 className="w-3 h-3" />
                  <span className="hidden sm:inline">{t('projectViewer.common.deleteAll')}</span>
                </button>
                <button
                  onClick={runAllDrafts}
                  title={t('projectViewer.drafts.startAllNow')}
                  aria-label={t('projectViewer.drafts.startAllNow')}
                  className="flex items-center justify-center gap-2 min-h-8 min-w-8 px-2.5 sm:px-6 py-2 sm:py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-[10px] font-bold uppercase tracking-widest rounded-xl shadow-lg shadow-blue-500/20 transition-all active:scale-95"
                >
                  <Play className="w-3.5 h-3.5 fill-current" />
                  <span className="hidden sm:inline">{t('projectViewer.drafts.startAllNow')}</span>
                </button>
              </>
            }
          />

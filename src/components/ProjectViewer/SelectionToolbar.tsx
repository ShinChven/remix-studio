...
export function SelectionToolbar({
  ...
  return (
    <div
      className={`sticky top-0 z-20 flex justify-between bg-white/40 dark:bg-black/40 backdrop-blur-2xl border border-neutral-200/50 dark:border-white/5 gap-2 sm:gap-3 shadow-lg shadow-black/20 p-3 rounded-none border-x-0 border-t-0 ${

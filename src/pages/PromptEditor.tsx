...
import { Save, ChevronLeft, StickyNote, Maximize2, Minimize2, Eye, Edit3, Calendar, FileText, Tag as TagIcon } from 'lucide-react';
          ...
          <div className="flex items-center gap-2 md:gap-3 justify-between md:justify-end">
             <div className="flex items-center bg-neutral-50 dark:bg-neutral-950 p-1 rounded-xl md:rounded-card border border-neutral-200 dark:border-neutral-800 mr-1 md:mr-2">
                ...
                <button
                  ...
                  className={`p-1.5 md:p-2 rounded-lg md:rounded-xl transition-all ${viewMode === 'preview' ? 'bg-neutral-200 dark:bg-neutral-800 text-blue-400 shadow-sm' : 'text-neutral-500 dark:text-neutral-500 hover:text-neutral-300'}`}
          ...
          <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
            ...
            {viewMode === 'preview' && (
              <div className="flex-1 min-w-0 flex flex-col h-full bg-neutral-50/30 dark:bg-neutral-950/30">
                ...
                <div className="flex-1 min-w-0 overflow-y-auto p-4 md:p-8 markdown-content custom-scrollbar">
                   {content.trim() === '' ? (

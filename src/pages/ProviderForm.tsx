...
const PROVIDER_TYPES: ProviderType[] = ['GoogleAI', 'VertexAI', 'RunningHub', 'OpenAI'];
...
export function ProviderForm() {
  ...
  return (
    <div className="min-h-full flex flex-col items-center py-12 md:py-16 px-4 md:px-8 bg-neutral-950">
      <div className="w-full max-w-2xl bg-neutral-900 border border-neutral-800 rounded-3xl p-5 md:p-8 shadow-2xl">

...
const PROVIDER_TYPES: ProviderType[] = ['GoogleAI', 'VertexAI', 'RunningHub'];
...
const TYPE_COLORS: Record<ProviderType, { selected: string; default: string }> = {
  GoogleAI:   { selected: 'bg-blue-600/10 border-blue-500/50 text-blue-400',     default: 'bg-neutral-950 border-neutral-800 text-neutral-600 hover:border-neutral-700' },
  VertexAI:   { selected: 'bg-purple-600/10 border-purple-500/50 text-purple-400', default: 'bg-neutral-950 border-neutral-800 text-neutral-600 hover:border-neutral-700' },
  RunningHub: { selected: 'bg-emerald-600/10 border-emerald-500/50 text-emerald-400', default: 'bg-neutral-950 border-neutral-800 text-neutral-600 hover:border-neutral-700' },
};
              ...
              {PROVIDER_TYPES.map(t => (
                <button
                  ...
                  className={`flex items-center gap-3 p-3 rounded-2xl border transition-all text-left ${
                    type === t ? TYPE_COLORS[t].selected : TYPE_COLORS[t].default
                  }`}
                >

...
export const PROVIDER_MODELS_MAP: Record<ProviderType, ModelConfig[]> = {
  ...
  RunningHub: [
    ...
    },
    {
      ...
      generatorId: 'RunningHub',
      modelId: 'bytedance/seedance-2.0-global',
      category: 'video',
    ...
    {
      id: 'runninghub-seedance-2-0-global-multimodal-reference-video',
      name: 'Seedance 2.0 Global Multimodal Reference',
      generatorId: 'RunningHub',
      modelId: 'bytedance/seedance-2.0-global/multimodal-video',
      category: 'video',
      promptLimit: { value: 20480, unit: 'characters' },
      options: {
        aspectRatios: ['adaptive', '16:9', '4:3', '1:1', '3:4', '9:16', '21:9'],
    ...
    {
      id: 'runninghub-minimax-hailuo-h3-video',
      name: 'MiniMax Hailuo H3',
      generatorId: 'RunningHub',
      modelId: 'minimax/hailuo-h3/image-to-video',
      category: 'video',
      promptLimit: { value: 20480, unit: 'characters' },
      options: {
        // Hailuo H3 takes no ratio parameter — the output follows the first frame.
